...
//    dialogContainer.layer.borderWidth = 1;
    ...
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, dialogContainer.bounds.size.height - buttonHeight - buttonSpacerHeight, dialogContainer.bounds.size.width, 0.5)];
    ...
    CGFloat buttonWidth = dialogContainer.bounds.size.width / buttonTitles.count;
    for (int i = 0; i < buttonTitles.count - 1; i++) {
        UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(buttonWidth * (i + 1), dialogContainer.bounds.size.height - buttonHeight - buttonSpacerHeight, 0.5, buttonHeight + buttonSpacerHeight)];
        lineView.backgroundColor = [UIColor colorWithRed:185.0/255.0 green:185.0/255.0 blue:185.0/255.0 alpha:1.0f];
        [dialogContainer addSubview:lineView];
    }

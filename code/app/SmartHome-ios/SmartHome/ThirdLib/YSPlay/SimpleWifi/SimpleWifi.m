...
- (BOOL)StartWifiConfig:(NSString *)strSSID andKey:(NSString *)strKey
{
    ...
    self.arrSsid = [[NSArray alloc] initWithArray:[self encodeNumSet:self.strSsid type:0]];
    
    self.strKey = strKey;
    self.arrKey = [[NSArray alloc] initWithArray:[self encodeNumSet:self.strKey type:1]];

...
- (void)initView
{
    ...
    [_backBtn setTitleColor:[UIColor colorWithHex:0x454545] forState:UIControlStateNormal];
    [_backBtn setTitleColor:[UIColor colorWithHex:0x454545] forState:UIControlStateHighlighted];
    ...
    _bottomView.backgroundColor = [UIColor colorWithHex:0xc8c7cc];//UIColorFromRGB(0xc8c7cc, 1.0f);

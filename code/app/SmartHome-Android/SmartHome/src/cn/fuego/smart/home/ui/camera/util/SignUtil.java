...
public class SignUtil 
{
    ...
    public static String getGetSmsCodeSign(String phone,String userId)
    {
        ...
        Map<String, Object> resultMap = paramsInit(EzvizConfigConst.APP_KEY,
                EzvizConfigConst.SECRET_KEY, "msg/get", map);
        JSONObject signJson;
        try {
    ...
    public static String getGetAccessTokenSign(String userId,String phone) 
    {
        Map<String, Object> map = new HashMap<String, Object>();
        {
            map.put("userId", userId);
        ...
        Map<String, Object> resultMap = paramsInit(EzvizConfigConst.APP_KEY,
        		EzvizConfigConst.SECRET_KEY, "token/accessToken/get", map);
        JSONObject signJson;
        try {
            signJson = setJosn(resultMap);
            return signJson.toString();

...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    public void setLoadingLayoutCreator(LoadingLayoutCreator creator) {
        super.setLoadingLayoutCreator(creator);
        ...
        if (mListViewExtrasEnabled) {
            ...
            mHeaderLoadingView = getLoadingLayoutCreator()
                    .create(getContext(), true, getPullToRefreshScrollDirection());
            ...
            mFooterLoadingView = getLoadingLayoutCreator().create(getContext(), false,

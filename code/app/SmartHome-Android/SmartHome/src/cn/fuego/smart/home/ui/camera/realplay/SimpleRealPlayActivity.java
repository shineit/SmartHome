...
import cn.fuego.smart.home.ui.camera.realplay.SimpleRealPlayerAdapter.RealPlayerHolder;
import cn.fuego.smart.home.ui.camera.util.VerifySmsCodeUtil;
import cn.fuego.smart.home.widget.PagesGallery;
 ...
 * 
 */
public class SimpleRealPlayActivity extends Activity implements OnClickListener, SurfaceHolder.Callback,
    ...
    private void initViews() {
        ...
        mGestureDetector = new GestureDetector(SimpleRealPlayActivity.this, onGestureListener);
    ...
    private void onOrientation() {
        ...
        if (mOrientation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            mDisplayView.setBackgroundColor(getResources().getColor(R.color.application_bg));

	...
	<s:form method="post" action="device/ConcentratorManage!modify.action" class="pageForm required-validate" name="concentForm" onsubmit="return iframeCallback(this,dialogAjaxDone);"  >
		<div class="pageFormContent" layoutH="58">
			...
			<dl style="width:100%;">
				...
				<dd style="width:80%;"><input type="text" name="concent.concentratorID"  size="30" readonly="readonly" value="${concent.concentratorID}"/></dd>
			</dl>
			<dl style="width:100%;">
				<dt style="width:15%;">IP地址：</dt>			
				<dd style="width:80%;"><input type="text" name="concent.ipAddr"  size="30" value="${concent.ipAddr}"/></dd>
			</dl>
			<dl style="width:100%;">
				<dt style="width:15%;">名称：</dt>			
				<dd style="width:80%;"><input type="text" name="concent.name"  size="30" value="${concent.name}"/></dd>
			</dl>
						
			<dl style="width:100%;">
				<dt style="width:15%;">描述：</dt>			
				<dd style="width:80%;"><textarea name="concent.description" cols="80" rows="8" maxlength="500">${concent.description}</textarea></dd>
			</dl>						
		</div>		

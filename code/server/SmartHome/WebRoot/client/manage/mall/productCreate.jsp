...
<div class="pageContent">
	<s:form method="post" action="mall/ProductManage!create.action" class="pageForm required-validate" name="KnowledgeForm" onsubmit="return iframeCallback(this,dialogAjaxDone);" enctype="multipart/form-data" >

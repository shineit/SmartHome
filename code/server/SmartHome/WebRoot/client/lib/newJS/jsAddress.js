...
var provinceList = [
//初始化参数                   
{name:'所在省份',cityList:[{name:'所在城市',areaList:['所在区县']}]},
...
{name:'台湾', cityList:[
{name:'台北市', areaList:['市辖区','中正区','大同区','中山区','松山区','大安区','万华区','信义区','士林区','北投区','内湖区','南港区','文山区']}, 
{name:'高雄市', areaList:['市辖区','新兴区','前金区','芩雅区','盐埕区','鼓山区','旗津区','三民区','左营区','楠梓区','小港区']},
{name:'基隆市', areaList:['市辖区','仁爱区','信义区','中正区','中山区','安乐区','暖暖区','七堵区']},
{name:'台中市', areaList:['市辖区','中区','东区','南区','西区','北区','北屯区','西屯区','南屯区']}, 
{name:'台南市', areaList:['市辖区','中西区','东区','南区','北区','安平区','安南区']}, 
{name:'新竹市', areaList:['市辖区','东区','北区','香山区']}, 
{name:'嘉义市', areaList:['市辖区','东区','西区']},
{name:'省直辖', areaList:['市辖区','台北县','宜兰县','新竹县','桃园县','苗栗县','台中县','彰化县','南投县','嘉义县','云林县','台南县','高雄县','屏东县','台东县','花莲县','澎湖县']},

]},
{name:'香港', cityList:[
{name:'香港岛', areaList:['中西区','湾仔区','东区','南区']},  
{name:'九龙', areaList:['油尖旺区','深水埗区','九龙城区','黄大仙区','观塘区']}, 
{name:'新界', areaList:['北区 ','大埔区','沙田区 ','西贡区','荃湾区','屯门区','元朗区','葵青区','离岛区 ']}, 
]},
{name:'澳门', cityList:[
{name:'澳门半岛', areaList:['花地玛堂区 ','圣安多尼堂区','大堂区','望德堂区','风顺堂区']}, 
{name:'澳门离岛', areaList:['嘉模堂区  ','圣方济各堂区 ']}, 
{name:'无堂区划分区域', areaList:['路氹城']}, 
]}
];
...
(function($){
	if ($.validator) {
		...
		$.validator.addMethod("mobilephone", function(value, element) {
			return this.optional(element) || /^(((\+86)|(86))?[1][3|5|7|8|][0-9]{9})$/.test(value);
		}, "Please specify a valid phone number");
		//座机号码，修改
		$.validator.addMethod("telephone", function(value, element) {
			return this.optional(element) || /^((\d{3,4}-)|(\d{3,4}))?\d{8}$/.test(value);
		...
		//电话组格式校验,数量为10
		$.validator.addMethod("phonelistTen", function(value, element) {
			return this.optional(element) || /^([1][3|5|7|8|][0-9]{9}[;]\s*){1,10}$/.test(value);
		}, "Please specify a valid phonelist num");
		//电话组格式校验";"，单个不限数量
		$.validator.addMethod("phonelistFormat", function(value, element) {
			return this.optional(element) || /^([1][3|5|7|8|][0-9]{9}[;]\s*)*$/.test(value);
		}, "Please specify a valid phonelist style");		
		...
		$.validator.addClassRules({
			...
			QQ:{QQ:true},
			phonelistTen:{phonelistTen:true},
			phonelistFormat:{phonelistFormat:true}
		});
...
function navTabAjaxDone(json){
	...
	if (json[DWZ.keys.statusCode] == DWZ.statusCode.ok){
		...
		} else if ("redirect" == json.callbackType){
			window.location.replace(json.forwardUrl);
			...
			function initSuffix($tbody) {
				$tbody.find('>tr').each(function(i){
					$(':input, a.btnLook, a.btnAttach', this).each(function(){
						...
						if (id) $this.attr('id', id.replaceSuffix(i)); //新增
